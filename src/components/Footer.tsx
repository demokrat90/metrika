        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:justify-items-center md:text-center">
          ...
          <div className="text-center md:text-center">
            ...
            <ul className="space-y-2 text-[#c9c9c9]">
              <li>
                <a href="https://metrika.ae/privacy-policy" target="_blank" rel="noopener noreferrer" className="hover:text-[#a39466] transition-colors">
                  سياسة الخصوصية
                </a>
              </li>
              <li>
                <a href="https://metrika.ae/cookie-policy" target="_blank" rel="noopener noreferrer" className="hover:text-[#a39466] transition-colors">
                  سياسة ملفات تعريف الارتباط
                </a>
              </li>
              <li>
                <a href="https://metrika.ae/terms_of_use" target="_blank" rel="noopener noreferrer" className="hover:text-[#a39466] transition-colors">
                  شروط الاستخدام
                </a>
              </li>
            </ul>
