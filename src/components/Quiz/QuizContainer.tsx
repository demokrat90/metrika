        ...
        <div className="max-w-3xl mx-auto mt-16 flex justify-between gap-6">
          ...
          {currentStep === totalSteps - 1 ? (
            ...
            <button
              onClick={handleNext}
              disabled={!canProceed()}
              className="group relative px-12 py-4 rounded-xl font-bold text-lg transition-all duration-300 overflow-hidden bg-[#333] text-[#555] hover:bg-gradient-to-l hover:from-[#a39466] hover:to-[#b8a775] hover:text-[#171717] hover:shadow-[0_8px_32px_rgba(163,148,102,0.4)] hover:-translate-y-0.5 disabled:hover:bg-[#333] disabled:hover:text-[#555] disabled:hover:shadow-none disabled:hover:translate-y-0 disabled:cursor-not-allowed"
            >
