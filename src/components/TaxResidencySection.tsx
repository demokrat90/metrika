...
export default function TaxResidencySection() {
  return (
    <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="rounded-2xl border border-[#2b2b2b] bg-[#171717]/75 p-6 backdrop-blur-[1px] overflow-hidden">
        ...
        <div className="mt-4 grid gap-4">
          <div className="h-16 md:h-20 flex items-center">
            <div className="flex items-center gap-4 w-full min-w-0">
              ...
              <p className="text-[#c9c9c9] text-sm md:text-base leading-relaxed whitespace-normal md:whitespace-nowrap break-words min-w-0">
                {taxItems[0].text}
              </p>
            </div>
          </div>
      ...
      <div className="rounded-2xl border border-[#2b2b2b] bg-[#171717]/75 p-6 backdrop-blur-[1px] overflow-hidden">
        ...
        <div className="mt-4 grid gap-4">
          <div className="min-h-[64px] md:min-h-[80px] flex flex-col justify-center">
            ...
            <p className="text-[#c9c9c9] text-sm md:text-base leading-relaxed whitespace-normal md:whitespace-nowrap break-words">{residencyItems[0].text}</p>
          </div>
          <div className="my-4 h-px bg-[#2b2b2b]" />
          <div className="min-h-[64px] md:min-h-[80px] flex flex-col justify-center">
            <p className="text-white font-bold mb-1">{residencyItems[1].title}</p>
            <p className="text-[#c9c9c9] text-sm md:text-base leading-relaxed whitespace-normal md:whitespace-nowrap break-words">{residencyItems[1].text}</p>
          </div>
        </div>
      </div>
    </div>
